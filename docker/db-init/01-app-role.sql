...
-- No-op at init time (schema is empty pre-migration); real grants come from the
-- ALTER DEFAULT PRIVILEGES below as migrations create tables. Kept for clarity/idempotence.
