...
export const DEFAULT_DENTAL_CATALOG: DefaultCatalogItem[] = [
  ...
  ...group('Operatoria', P, '#2563EB', [
    ...
    [
      ...
      'Inlay / onlay',
      'Incrustação (inlay/onlay)',
    ],
    [
      'OP-POSTE',
      'Reconstrucción con poste',
      'Post & core buildup',
      'Reconstrução com pino',
    ],
    [
      'OP-RECUB-PULPAR',
  ...
  ...group('Cirugía oral', P, '#7C3AED', [
    ...
    [
      'CX-CORDAL-ERUP',
      'Extracción de cordal erupcionado',
      'Erupted third molar extraction',
      'Extração de siso irrompido',
    ],
    [
      'CX-CORDAL-INCL',
      'Extracción de cordal incluido',
      'Impacted third molar extraction',
      'Extração de siso incluso',
    ],
  ...
  ...group('Prótesis', P, '#CA8A04', [
    ...
    [
      ...
      'Prótese parcial removível metálica',
    ],
    [
      'PROT-TOTAL',
  ...
  ...group('Odontopediatría', P, '#F59E0B', [
    ...
    [
      'PED-FLUOR',
      'Aplicación de flúor pediátrico',
      'Pediatric fluoride',
      'Flúor pediátrico',
    ],
    [
    ...
    [
      'PED-CORONA-ACERO',
      'Corona de acero pediátrica',
      'Stainless steel crown',
      'Coroa de aço pediátrica',
    ],
    [
      'PED-PULPOTOMIA',
      'Pulpotomía pediátrica',
      'Pediatric pulpotomy',
      'Pulpotomia pediátrica',
    ],
    [
      'PED-MANTENEDOR',
  ...
  ...group('Estética', P, '#06B6D4', [
    ...
    [
      'EST-BLANQ-CASA',
      'Blanqueamiento ambulatorio (casa)',
      'Take-home whitening',
      'Clareamento caseiro',
    ],
    [
  ...
  ...group('Urgencias', P, '#EA580C', [
    ...
    [
      'URG-RECEMENTADO',
      'Recementado de corona/puente',
      'Crown/bridge re-cementation',
      'Recimentação de coroa/ponte',
    ],
  ]),
];
